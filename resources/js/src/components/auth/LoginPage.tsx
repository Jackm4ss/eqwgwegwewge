...
function PasswordStrength({ password }: { password: string }) {
  ...
  return (
    <motion.div
      ...
      aria-live="polite"
    >
      <div className="flex gap-1 mb-1" role="img" aria-label={`Kekuatan password: ${labels[score]}`}>
        {[1, 2, 3, 4].map(i => (
          <motion.div
            key={i}
...
export function LoginPage() {
  ...
  const handleSocialLogin = (provider: string) => {
    toast.info(`Menghubungkan ke ${provider}...`, { description: 'Fitur ini segera hadir.' });
  };
          ...
          >
            ...
            >
              ...
              <div className="relative">
                ...
                <p className="text-sky-100 text-sm mt-1">
                  Sistem Manajemen Gate & Dashboard Operasional
                </p>
            ...
            <div className="bg-white px-8 py-7">
              <form
                ...
                noValidate
                aria-label="Formulir Masuk Songkran Music Festival"
              >
                {/* Email */}
                <div className="mb-5">
                ...
                <div className="flex items-center gap-3 my-5" aria-hidden="true">
                  ...
                  <span className="text-slate-400 text-xs font-medium px-1">atau masuk dengan</span>
                  <div className="flex-1 h-px bg-slate-200" />
                </div>

                {/* Social login */}
                <div className="flex gap-3" role="group" aria-label="Opsi masuk alternatif">
                  <SocialButton
                    label="Google"
            ...
            <div className="bg-gradient-to-r from-sky-50 to-cyan-50 px-8 py-5 border-t border-sky-100 text-center">
              <p className="text-slate-500 text-xs flex items-center justify-center gap-2">
                ...
                Masalah akses? Hubungi <span className="font-bold text-sky-700">IT Support Dashboard</span>
              </p>
            </div>
          </motion.div>
            ...
            <div style={{ perspective: '1200px' }}>
              ...
              >
                ...
                <p className="text-sky-200 text-xs uppercase tracking-[0.2em] mb-5 font-black flex items-center gap-2.5">
                  ...
                  Fitur Operasional Petugas
                </p>

                <ul className="space-y-4 list-none p-0 m-0 mb-6">
                  {[
                    { icon: QrCode, text: 'Pemindaian Tiket & QR Access Control', color: 'text-sky-300' },
                    { icon: Activity, text: 'Monitoring Arus Pengunjung Real-time', color: 'text-cyan-300' },
                    { icon: HardDrive, text: 'Sinkronisasi Data Gate & Lokasi', color: 'text-blue-300' },
                    { icon: ShieldCheck, text: 'Verifikasi Identitas & Blacklist Check', color: 'text-emerald-300' },
                  ].map((item, i) => (
                    <motion.li
                      key={i}
                ...
                <div className="pt-5 border-t border-white/20 mt-2">
                  <p className="text-sky-100 text-xs leading-relaxed uppercase tracking-wider font-semibold text-center">
                    Sistem Akses Internal © 2026 SONGKRAN IT DIV.<br />
